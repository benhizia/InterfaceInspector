...
constexpr std::array<MemberInfo, 4> SmartPointer_meta = {
    { "ptr_", 0, 0, 0 },    { "ref_count_", 8, 0, 0 },    { "mutex_", 16, 0, 0 },    { "deleter_", 24, 0, 0 }};
constexpr std::array<MemberInfo, 5> FileHandle_meta = {
    { "file_descriptor_", 0, 0, 0 },    { "file_path_", 8, 0, 0 },    { "access_mode_", 32, 0, 0 },    { "is_open_", 36, 0, 0 },    { "error_flag_", 37, 0, 0 }};
constexpr std::array<MemberInfo, 3> Vector3D_meta = {
    { "x_", 0, 0, 0 },    { "y_", 8, 0, 0 },    { "z_", 16, 0, 0 }};
