...
constexpr std::array<MemberInfo, 4> Configuration_meta = {
    { "system_name", 0, 0, 0 },    { "max_connections", 24, 0, 0 },    { "timeout_seconds", 32, 0, 0 },    { "default_status", 40, 0, 0 }};
...
constexpr std::array<MemberInfo, 5> ComplexSystem_meta = {
    { "config_", 8, 0, 0 },    { "handler_", 56, 0, 0 },    { "current_status_", 64, 0, 0 },    { "subsystems_", 72, 0, 0 },    { "subsystem_count_", 136, 0, 0 }};
constexpr std::array<MemberInfo, 1> Drawable_meta = {
    { "render_priority_", 8, 0, 0 }};
constexpr std::array<MemberInfo, 1> Updateable_meta = {
    { "last_update_time_", 8, 0, 0 }};
constexpr std::array<MemberInfo, 4> GameObject_meta = {
    { "object_name_", 32, 0, 0 },    { "position_x_", 56, 0, 0 },    { "position_y_", 60, 0, 0 },    { "is_visible_", 64, 0, 0 }};
...
constexpr std::array<MemberInfo, 0> basic_streambuf<char>_meta = {
};
constexpr std::array<MemberInfo, 0> basic_streambuf<wchar_t>_meta = {
};
...
constexpr std::array<MemberInfo, 0> ios_base_meta = {
};
constexpr std::array<MemberInfo, 0> basic_ios<char>_meta = {
};
constexpr std::array<MemberInfo, 0> basic_ios<wchar_t>_meta = {
};
...
constexpr std::array<MemberInfo, 2> initializer_list<char32_t>_meta = {
    { "__begin_", 0, 0, 0 },    { "__size_", 8, 0, 0 }};
constexpr std::array<MemberInfo, 2> EventHandler_meta = {
    { "parent_system_", 0, 0, 0 },    { "is_enabled_", 8, 0, 0 }};
...
constexpr std::array<MemberInfo, 1> time_point<std::chrono::steady_clock, std::chrono::duration<long long, std::ratio<1, 1000000000>>>_meta = {
    { "__d_", 0, 0, 0 }};
constexpr std::array<MemberInfo, 0> time_point<std::chrono::system_clock>_meta = {
};
